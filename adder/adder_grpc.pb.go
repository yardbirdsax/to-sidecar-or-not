...
type AdderClient interface {
	Add(ctx context.Context, in *AdderGRPCInput, opts ...grpc.CallOption) (*AdderGRPCResult, error)
}
...
func (c *adderClient) Add(ctx context.Context, in *AdderGRPCInput, opts ...grpc.CallOption) (*AdderGRPCResult, error) {
	out := new(AdderGRPCResult)
...
type AdderServer interface {
	Add(context.Context, *AdderGRPCInput) (*AdderGRPCResult, error)
...
func (UnimplementedAdderServer) Add(context.Context, *AdderGRPCInput) (*AdderGRPCResult, error) {
...
func _Adder_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).Add(ctx, req.(*AdderGRPCInput))
	}
